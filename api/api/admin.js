// /api/admin — статистика для владельца (только с ADMIN_TG_ID).
//   GET ?admin=<tgId>  -> {users, payments:{pending,approved,rejected}, revenue, recent}
